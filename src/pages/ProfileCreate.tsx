    ...
    <div className="min-h-screen py-8 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-purple-600">Complete Your Profile</h1>
          <p className="text-gray-600">Add your company details for invoice generation</p>
        </div>
        ...
        <Card className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit}>
                ...
                <TabsContent value="company" className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <Input id="tagline" placeholder="All types of services provided" />
                    </div>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <Input id="mobile" type="tel" placeholder="+91 9999999999" />
                    </div>
                  </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      ...
                      <Input id="gstin" placeholder="22AAAAA0000A1Z5" required />
                    </div>
                    
                    <div>
                      <Label htmlFor="panNumber">PAN Number*</Label>
                      <Input id="panNumber" placeholder="AAAAA0000A" required />
                    </div>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="bank" className="space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      ...
                      <Input id="ifscCode" placeholder="BANK0123456" required />
                    </div>
                    
                    <div>
                      <Label htmlFor="branchName">Branch Name*</Label>
                      <Input id="branchName" placeholder="Branch Location" required />
                    </div>
                  </div>
                  
                  <div>
                    <Label htmlFor="accountType">Account Type*</Label>
                    <Input id="accountType" placeholder="Current/Savings" required />
                  </div>
            ...
            <CardFooter className="flex justify-between">
              <Button variant="outline" type="button" onClick={() => navigate("/login")}>Back</Button>
